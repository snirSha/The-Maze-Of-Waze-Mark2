...
public class SimpleDB {
	...
	public static void main(String[] args) {
		...
		int level = 0;
		//allUsers();
		System.out.println(getBestScore(23));
		//printLog();
	...
	///////////////////////snir's shit//////////////////////////////////////////////////////////////////////////
	public static int getBestScore(int levelTmp) {
		...
		try {
			...
			String allCustomersQuery = "SELECT UserID,score,moves FROM Logs WHERE UserID=204040687 AND levelID="+levelTmp+" AND moves<="+mb+";";
